        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="home.html" class="nav-link">Categorías</a>
                </li>
            </ul>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        $respuesta = categoriasController::selectAll();
                        ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="">
                                            ...
                                            <td>
                                                <a href="categoriaEditar.php?id=<?=$value['id']?>" class="btn btn-warning">EDITAR</a>
                                                <a href="categoriaEliminar.php?id=<?=$value['id']?>" class="btn btn-danger">ELIMINAR</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="categoriaAgregar.php" method="post">
