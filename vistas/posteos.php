        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="home.html" class="nav-link">POSTS</a>
                </li>
            </ul>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        $respuesta = posteosController::selectAll();
                        ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="">
                                            ...
                                            <td scope="row"><?php echo $value['fecha'] ?></td>
                                            <td><?php echo $estado = $value['estado'] == 1 ? 'Creado' : 'Publicado'; ?></td>
                                            <td>
                                                <a href="posteoEditar.php?id=<?= $value['id'] ?>" class="btn btn-warning">EDITAR</a>
                                                <a href="posteoEliminar.php?id=<?= $value['id'] ?>" class="btn btn-danger">ELIMINAR</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
